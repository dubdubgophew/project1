...
export const metadata: Metadata = {
  ...
  description: 'Toolora Terms of Service. Read our usage terms, subscription policies, and content guidelines.',
};
      ...
      <main className="min-h-screen bg-gray-950 pt-24 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-sm max-w-none prose-invert prose-p:text-gray-400 prose-h2:text-white prose-h2:text-xl prose-h2:mt-8 prose-li:text-gray-400">
            <p>By using Toolora (&quot;the Service&quot;), you agree to these Terms. Please read them carefully.</p>

            <h2>1. Acceptable Use</h2>
            <p>You may use Toolora for lawful purposes only. You may not:</p>
            <ul>
            ...
            <p>Pro and Unlimited plans are billed monthly. You may cancel at any time; cancellation takes effect at the end of the billing period. We offer a 7-day money-back guarantee for first-time subscribers — email support@toolora.com within 7 days of payment.</p>
            ...
            <p>Toolora&apos;s liability is limited to the amount you paid in the last 3 months. We are not liable for indirect, incidental, or consequential damages.</p>
            ...
            <h2>10. Contact</h2>
            <p>Questions: <a href="mailto:support@toolora.com" className="text-violet-400">support@toolora.com</a></p>
          </div>
        </div>
      </main>
      <Footer />

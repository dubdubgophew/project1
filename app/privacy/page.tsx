      ...
      <main className="min-h-screen bg-[#F9F7F4] pt-24 pb-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-sm max-w-none prose-invert prose-p:text-gray-400 prose-h2:text-white prose-h2:text-xl prose-h2:mt-8 prose-li:text-stone-500">
            ...
            <p>You have the right to: access your data, correct inaccurate data, delete your account and all associated data, export your data. Email <a href="mailto:privacy@formly.tools" className="text-orange-500">privacy@formly.tools</a> to exercise these rights.</p>
            ...
            <h2>8. Contact</h2>
            <p>For privacy concerns: <a href="mailto:privacy@formly.tools" className="text-orange-500">privacy@formly.tools</a>.<br />Formly, India.</p>
          </div>
        </div>
      </main>
      <Footer />

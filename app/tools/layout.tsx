...
export const metadata: Metadata = {
  title: 'All 50 Free AI Tools — Image Compressor, PDF Merger, Resume Builder & More | Formly',
  description: 'Browse all 50 free tools on Formly: image compressor, merge PDF, split PDF, image converter, pay stub generator, resume builder, grammar checker, PDF summarizer & more. No signup needed.',
  ...
  openGraph: {
    title: 'All 50 Free AI Tools | Formly',
  ...
  twitter: {
    ...
    title: 'All 50 Free AI Tools | Formly',
    description: '50 free tools: image compressor, merge PDF, split PDF, pay stub generator, resume builder, paraphraser, grammar checker & more. No signup needed.',
  },
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Complete list of 50 free tools available on Formly — AI tools, file converters, PDF tools, calculators & more',
            url: 'https://formly.tools/tools',
            numberOfItems: 50,
            itemListElement: [

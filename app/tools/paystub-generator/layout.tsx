...
export const metadata: Metadata = {
  title: 'Free Pay Stub Generator — USA, UK, Canada 2026 | Formly',
  description: 'Free pay stub generator online — create accurate pay stubs for USA, UK, and Canada instantly. 2026 tax tables, all 50 US states, PDF download. No signup required.',
  keywords: ['free pay stub generator online', 'pay stub generator', 'paystub generator free', 'free paycheck stub creator', 'online pay stub maker', 'paycheck generator', 'pay slip generator', 'salary stub generator', 'free paystub maker', 'create pay stub online', 'pay stub template free', 'pay stub generator usa', 'pay stub generator canada', 'pay stub 2026'],
  openGraph: { title: 'Free Pay Stub Generator — USA, UK, Canada 2026 | Formly Tools', description: 'Free pay stub generator — create accurate pay stubs for USA, UK, Canada instantly. 2026 tax tables, all 50 US states, PDF download. No signup required.', url: 'https://formly.tools/tools/paystub-generator', type: 'website', siteName: 'Formly Tools' },
  twitter: { card: 'summary_large_image', title: 'Free Pay Stub Generator 2026 — USA, UK, Canada | Formly Tools', description: 'Free pay stub generator — USA, UK, Canada, 2026 tax tables. PDF download, no signup required.' },
  ...
  return (
    <>
      <ToolSchemas
        ...
        description="Free online pay stub generator with accurate 2026 tax calculations for USA, UK, Canada, India, Australia, New Zealand, Ireland, and Singapore."
        url="https://formly.tools/tools/paystub-generator"
        category="FinanceApplication"
        features={['Supports 8 countries with 2026 tax tables', 'All 50 US states supported', 'Employer & employee contributions', 'Professional PDF download', 'Live preview before download']}
        faqs={[
        ...
        steps={[
          { name: 'Select your country', text: 'Choose your country from USA, UK, Canada, India, Australia, New Zealand, Ireland, or Singapore to load the correct 2026 tax tables.' },

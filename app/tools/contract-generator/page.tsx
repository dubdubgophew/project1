...
import { Copy, Check, Loader2, AlertCircle, Scroll } from 'lucide-react';
    ...
    >
      ...
      {output && (
        <div className="card">
          ...
          <pre className="text-gray-300 text-xs leading-relaxed whitespace-pre-wrap font-mono overflow-x-auto bg-gray-800/50 p-4 rounded-xl">
            {output}
          </pre>
        </div>
      )}

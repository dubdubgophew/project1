...
const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: 'When can you retire early? Get your FIRE number, exact retirement age, and Lean / Fat / Coast FIRE milestones with the 4% rule.',
    href: '/tools/fire-calculator',
    badge: 'New',
    color: 'from-orange-500/10 to-red-500/5 border-orange-500/20 hover:border-orange-500/40',
    tags: ['fire', 'retire early', 'financial independence', '4 percent rule', 'retirement'],
    category: 'Finance',
  },
  {
    icon: '🍽️',
    ...
    tags: ['meal plan', 'grocery list', 'diet', 'keto', 'vegan', 'meal prep'],
...
export default function ToolsPage() {
  return (
    <>
      <Header />
      <main id="main-content" className="min-h-screen bg-[#F9F7F4] pt-24">

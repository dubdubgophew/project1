...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Formly Tools — 50 Free AI Tools Online | No Signup Required',
    description: '50 free AI-powered tools in one place. Pay stubs, resumes, contracts, grammar check, PDF summarizer, image compressor, merge PDF & more. No signup needed.',
  ...
  twitter: {
    ...
    description: '50 free AI tools: pay stubs, resumes, grammar checker, PDF summarizer, image compressor, merge PDF & more. No signup needed.',
  },
};

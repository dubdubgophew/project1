...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Formly Tools — 50 Free AI Tools Online | No Signup Required',
    description: '50 free AI-powered tools in one place. Pay stubs, resumes, compliance AI, grammar check, PDF summarizer, image compressor, merge PDF & more. No signup needed.',
  ...
  twitter: {
    ...
    title: 'Formly Tools — 50 free AI tools | No Signup',
    description: '50 free AI tools: pay stubs, resumes, compliance AI, grammar checker, PDF summarizer, image compressor, merge PDF & more. No signup needed.',
  },
};

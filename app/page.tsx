...
export const metadata: Metadata = {
  title: 'Formly Tools — 52 Free AI Tools Online | No Signup Required',
  description:
    '52 free AI tools: pay stubs, ATS scanner, compliance AI, resume builder, grammar checker, PDF summarizer, merge PDF & more. No signup, no credit card.',
  keywords: [
  ...
  openGraph: {
    title: 'Formly Tools — 52 Free AI Tools Online | No Signup Required',
    description: '52 free AI-powered tools in one place. Pay stubs, resumes, compliance AI, grammar check, PDF summarizer, image compressor, merge PDF & more. No signup needed.',
  ...
  twitter: {
    ...
    title: 'Formly Tools — 52 free AI tools | No Signup',
    description: '52 free AI tools: pay stubs, resumes, compliance AI, grammar checker, PDF summarizer, image compressor, merge PDF & more. No signup needed.',
  },
};
...
const webPageSchema = {
  ...
  url: 'https://formly.tools',
  name: 'Formly Tools — 52 Free AI Tools Online',
  description: '52 free AI tools: pay stubs, ATS scanner, compliance AI, resume builder, grammar checker, PDF summarizer, merge PDF & more. No signup required.',

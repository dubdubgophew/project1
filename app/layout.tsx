...
const dmSerifDisplay = DM_Serif_Display({
  ...
  display: 'swap',
  preload: true, // used in Hero h1 (LCP element) — preload to reduce render delay
  weight: '400',
  style: 'normal',
});
...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Formly Tools — 52 Free AI Tools Online | No Signup Required',
  ...
  openGraph: {
    ...
    title: 'Formly Tools — 52 Free AI Tools Online | No Signup',
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Formly Tools — 52 Free AI Tools Online',
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Formly Tools — 52 Free AI Tools Online',
    ...
    <html lang="en" className={`${plusJakartaSans.variable} ${jetbrainsMono.variable} ${dmSerifDisplay.variable}`}>
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          url: 'https://formly.tools',
          description: 'Formly Tools provides 52 free tools for professionals worldwide — image compressor, merge PDF, split PDF, pay stub generator, resume builder, grammar checker, AI paraphraser, contract generator, PDF summarizer, diagram maker, and more. No signup required. Used by 50,000+ professionals in the USA, UK, India, Australia, and Canada.',
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          description: 'Browse 52 free AI tools organized by category: AI Writing, Payroll & Legal, Developer Tools, Finance, Utilities, and more.',
